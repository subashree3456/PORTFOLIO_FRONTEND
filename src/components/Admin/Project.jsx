          ...
          {user &&
            ...
            user.projects.map((item) => (
              <ProjectCard
                id="1"
                key="12"
                url="https://github.com/subashree3456/"
                projectImage="Image"
                projectTitle="FSD"
                description="To develop my skills and my innovation and to work with others to learn different ideas. To build a successful and good profile
